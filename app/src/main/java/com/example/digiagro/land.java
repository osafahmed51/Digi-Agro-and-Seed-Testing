...
public class land extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    LinearLayout landsuggest, landattri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        landsuggest = findViewById(R.id.landsuggest);
        landattri = findViewById(R.id.landattri);
         landsuggest.setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View view) {
                 Intent i = new Intent(land.this, map.class);
                 startActivity(i);
             }
         });
         landattri.setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View v) {
                 Intent i = new Intent(land.this, LandAttributes.class);
                 startActivity(i);
             }
         });
